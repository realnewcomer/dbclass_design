      ...
      <div class="front-header-center">
        <div class="front-header-nav">
          <el-menu :default-active="$route.path" mode="horizontal" router>
            ...
            <el-menu-item index="/front/information">用户资源中心</el-menu-item>
            <el-menu-item index="/front/question">题库</el-menu-item>
<!--            <el-menu-item index="/front/gpt">大语言模型</el-menu-item>
            <el-menu-item index="/front/demo">任务</el-menu-item>-->
          </el-menu>
        </div>
      </div>
        ...
        <div v-else>
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <div style="text-decoration: none" @click="navTo('/front/like')">我的喜欢</div>
              </el-dropdown-item>
              <el-dropdown-item>
