  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="img" label="题库封面" show-overflow-tooltip>
        ...
        <el-table-column prop="name" label="题库名称" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="题库信息" :visible.sync="fromVisible" width="55%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="name" label="题库名称">
          <el-input v-model="form.name" autocomplete="off" placeholder="请输入题库名称"></el-input>
        </el-form-item>
