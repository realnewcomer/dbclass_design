  ...
  <div class="main-content">
    <div style="width: 70%; margin: 20px 300px; min-height: 1000px">
      <div style="text-align: center">
        ...
        <span style="font-size: 20px; font-weight: 550; color: #333333; margin-left: 20px">第三章</span>
      </div>
      <div>
      ...
      <div>
        ...
        <div >
          <video src="../../assets/video/3-数据链路层.mp4"  controls style="width: 100%; height: 600px"></video>
...
export default {
  ...
  methods: {
    ...
    loadComments() {
      this.$request.get('/comment/selectByGoodsId?id=' + 94).then(res => {
        if (res.code === '200') {
