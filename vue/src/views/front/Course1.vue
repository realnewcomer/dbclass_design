  ...
  <div class="main-content">
    <div style="width: 70%; margin: 20px 300px; min-height: 1000px">
      <div style="text-align: center">
        ...
        <span style="font-size: 20px; font-weight: 550; color: #333333; margin-left: 20px">第一章</span>
      </div>
      <div>
      ...
      <div>
        ...
        <div >
          <video src="../../assets/video/1-计算机网络概述.mp4"  controls style="width: 100%; height: 600px"></video>
...
<!--        <div style="font-size: 18px">课程介绍</div>-->
      ...
      <div label="评价" name="second" style="height: 500px;border-top: 3px solid black;border-left: 3px solid black;border-right: 3px solid black;">
...
export default {
  ...
  methods: {
    ...
    loadComments() {
      this.$request.get('/comment/selectByGoodsId?id=' + 92).then(res => {
        if (res.code === '200') {
