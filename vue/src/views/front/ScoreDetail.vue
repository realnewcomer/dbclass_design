<template>
  <div class="main-content">
    <div style="width: 70%; margin: 30px 300px; min-height: 1000px">
      ...
      <div style="text-align: center; margin-top: 15px">
        <span style="color: green" v-if="courseData.price > 0">学习该课程需要 {{ courseData.price }} 积分</span>
      ...
      <div>
        ...
        <div v-if="courseData.price === 0 ||flag">
          <video :src="courseData.video" v-if="courseData.type === 'VIDEO'" controls style="width: 100%; height: 600px"></video>
