...
public interface InformationMapper {
    ...
    */
    ...
    @Select("select * from manager.information where recommend = '是' and status = '审核通过'")
    Information selectRecommend();

    @Select("select * from manager.information where recommend = '否' and status = '审核通过' order by id desc limit 8")
